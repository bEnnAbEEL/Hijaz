	...
	function tommusrhodus_custom_metaboxes( $meta_boxes ) {
		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				...
				array(
					'name'         => esc_html__( 'Disable header utility bar on this page?', 'uptime' ),
					'desc'         => esc_html__( 'If turned on in the theme options, this will override that option on this page only.', 'uptime' ),
					'id'           => $prefix . 'header_utility',
					'type'         => 'select',
					'options'      => array(
						'no'  => 'No',
						'yes' => 'Yes'
