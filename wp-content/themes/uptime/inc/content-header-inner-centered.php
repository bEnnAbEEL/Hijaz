<?php
	...
	$label2 = get_theme_mod( 'header_button_label_2' );
	$url2   = get_theme_mod( 'header_button_url_2' ) ;
?>
	...
	<div class="collapse navbar-collapse justify-content-end col flex-fill px-0">
		...
		<?php if( $label && $url ) : ?>
			<div class="collapse navbar-collapse justify-content-end col flex-fill px-0">
				...
				<?php if( $label2 && $url2 ) : ?>
					<a href="<?php echo esc_url( $url2 ); ?>" class="btn btn-outline-primary ml-lg-1"><?php echo wp_kses_post( $label2 ); ?></a>
				<?php endif; ?>
